...
const customsearch = google.customsearch('v1');
	...
	application.get('/news', function(req, res){
		console.log("abriu news");
		res.render('home/news.ejs');
	});
	...
	application.get('/ranking', function(req, res){
		res.render('home/ranking.ejs');
	});

	application.get('/ranking_news', isLoggedIn, function(req, res){
		res.render('home/ranking_news.ejs', {
			user:req.user
		});
	});
